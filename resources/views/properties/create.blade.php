                    ...
                    <form action="{{ route('properties.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror"
                                id="alamat" rows="2" required>{{ old('alamat') }}</textarea>
                            @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="jeniskost_id"
                                        ...
                                        <option value="{{ $jenis->id }}" {{ old('jeniskost_id')==$jenis->id ? 'selected'
                                            : '' }}>
                                            {{ $jenis->nama }}
                                        </option>
                                        @endforeach
                        ...
                        <div class="mb-3">
                            ...
                            <div id="payment-methods-container">
                                ...
                                <div class="payment-method-item border rounded p-3 mb-3" data-index="{{ $i }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="metode_pembayaran[{{ $i }}][nama_bank]"
                                                    class="form-control @error('metode_pembayaran.'.$i.'.nama_bank') is-invalid @enderror"
                                                    value="{{ old('metode_pembayaran.'.$i.'.nama_bank') }}" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="metode_pembayaran[{{ $i }}][no_rek]"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="metode_pembayaran[{{ $i }}][atas_nama]"
                                                    class="form-control @error('metode_pembayaran.'.$i.'.atas_nama') is-invalid @enderror"
                                                    value="{{ old('metode_pembayaran.'.$i.'.atas_nama') }}" required>
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="peraturan_id[]"
                                            value="{{ $p->id }}" id="peraturan{{ $p->id }}" {{ in_array($p->id,
                                        old('peraturan_id', [])) ? 'checked' : '' }}
                                        {{ $loop->first ? 'required' : '' }}>
