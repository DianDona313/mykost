                    ...
                    @if ($property->foto)
                        <div class="position-relative mb-3">
                            <img src="{{ asset('storage/properti_foto/' . $property->foto) }}"
                                class="img-fluid rounded-3 w-100 shadow-sm" style="object-fit: cover; height: 400px;"
                                alt="Foto Properti">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center p-2 bg-white rounded shadow-sm">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <br>
                                                            <small style="color: #57A438;">a.n.
                                                                {{ $metode->atas_nama }}</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center justify-content-md-start">
                        ...
                        @can('properti-edit')
                            ...
                            @if ($user->can('properti-edit-all') || $isManager)
                                <a href="{{ route('properties.edit', $property->id) }}" class="btn btn-lg px-4"
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const lat = {{ $property->latitude ?? -2.9761 }};
            const lng = {{ $property->longitude ?? 104.7754 }};
