        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    {!! html()->text('name')->class('form-control')->placeholder('Enter role name') !!}
                    @error('name')
                        ...
                        @foreach($permissions as $permission)
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    {!! html()->checkbox('permissions[]', false, $permission->name)->class('form-check-input')->id('permission_'.$permission->id) !!}
