<div class="container-fluid service py-5" style="background: linear-gradient(135deg, #398423 0%, #57A438 100%);">
                                        ...
                                        <div class="card border-0 shadow-lg h-100 overflow-hidden" style="border-radius: 20px;">
                                            ...
                                            <div class="position-relative overflow-hidden">
                                                ...
                                                <div class="position-absolute top-0 end-0 m-3">
                                                    <span class="badge px-3 py-2 rounded-pill" style="background-color: #F09F38;">
                                            ...
                                            <div class="card-body d-flex flex-column p-4">
                                                <div class="mb-3">
                                                    ...
                                                    <p class="card-text text-muted mb-3">
                                                        <i class="fas fa-map-marker-alt me-2" style="color: #398423;"></i>
                                                        {{ $property->alamat }}
                                                    </p>
    ...
    <a href="{{ route('all_kost') }}"
       class="btn text-white py-3 px-5 rounded-pill fw-bold text-uppercase"
