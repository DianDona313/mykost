    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('pengelolas.store') }}" method="POST" enctype="multipart/form-data" id="pengelolaForm">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="deskripsi" 
                                              ...
                                              id="deskripsi" 
                                              rows="4"
                                              placeholder="Deskripsi tambahan tentang pengelola (opsional)">{{ old('deskripsi') }}</textarea>
                                    @error('deskripsi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <!-- Image Preview -->
                                <div class="mb-3">
                                    <div class="avatar avatar-xxl position-relative" id="imagePreviewContainer" style="display: none;">
                                        <img src="" alt="Preview" class="w-100 border-radius-lg shadow-sm" id="imagePreview">
                                        <button type="button" class="btn btn-sm btn-icon-only bg-gradient-light position-absolute top-0 end-0 mb-n2 me-n2" onclick="removeImagePreview()">
                                ...
                                <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                                    <img class="w-10 me-3 mb-0" src="{{ asset('assets/images/info.png') }}" alt="info">
                                    <div>
                                        <h6 class="mb-0">Info</h6>
                                        <p class="text-sm mb-0">Password default akan digenerate otomatis dan dikirim via email.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
